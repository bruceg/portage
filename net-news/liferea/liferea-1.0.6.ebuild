...
# $Header: /var/cvsroot/gentoo-x86/net-news/liferea/liferea-1.0-r1.ebuild,v 1.1 2006/01/13 23:14:23 citizen428 Exp $
...
src_unpack () {
	unpack ${A}
	cd ${S}
	epatch ${FILESDIR}/liferea-firefox-1.5.patch
}
